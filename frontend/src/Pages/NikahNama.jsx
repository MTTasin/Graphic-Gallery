...
export default function NihahNama() {
      ...
      <div className="relative">
        ...
        <div className={loading ? "opacity-10 z-0" : ""}>
          <div className="bg-black">
            <h2 className="text-3xl md:text-5xl pt-10 my-10 font-bold text-white text-center">
              Here are all the Nikah Nama collections
            </h2>
